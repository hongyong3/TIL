...
// exsercise 1-2 아래 코드의 images 배열안에 있는 정보(height, width)를 곱해 넓이를 구하여 areas 배열에 
...
// exercise 2-1 map 헬퍼를 사용해, images 배열 안의 height 들만 저장되어 있는 heights 배열에 저장해보자.
const images = [
...
// exercise 3-1 filter 헬퍼를 사용해서, numbers 배열중 50보다 큰 값들만 필터링해서 filteredNumbers 에 저장하라.
